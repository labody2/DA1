...
<div class="grid w-full grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
        <?php
            ...
            //get_products
                ...
                // $categoryName = getCategoryNameById($conn, $product["categoryId"]);
                // echo $categoryName;
        ?>
        ...
        <div class="relative mx-auto w-full">
            ...
            <div class="rounded-lg bg-white p-4 shadow">
                ...
                <span class="absolute top-0 right-2 z-10 mt-3 ml-3 inline-flex select-none rounded-sm bg-[#1f93ff] px-2 py-1 text-xs font-semibold text-white"> <?= $product["categoryId"] ?> </span>
                ...
                <p class="text-primary mt-2 inline-block whitespace-nowrap rounded-xl font-semibold leading-tight">
                    ...
                    <span class="text-2xl"> <?= $product["price"] ?></span>đồng
                </p>
                </div>
                <div class="mt-4">
