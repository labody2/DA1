    ...
    if ($password !== $confirmPassword) {
        ...
        if (mysqli_num_rows($checkResult) > 0) {
            ...
            if (mysqli_query($conn, $sql)) {
                ...
                $errorMsg = "Lỗi: " . mysqli_error($conn);
            }
        }
    }
}
...
?>
  ...
  <?php if (!empty($errorMsg)): ?>
    <div role="alert" class="rounded border-s-4 border-red-500 bg-red-50 p-4" style=" position: fixed; top: 0; left: 0; right: 0; z-index: 9999;">
        <p class="block font-medium text-red-800">Lỗi:</p>
        <p class="mt-2 text-sm text-red-700"><?php echo $errorMsg; ?></p>
    </div>
<?php endif; ?>
<?php if (!empty($successMsg)): ?>
    <div role="alert" class="rounded border-s-4 border-green-500 bg-green-50 p-4" style=" position: fixed; top: 0; left: 0; right: 0; z-index: 9999;">
        <strong class="block font-medium text-green-800">Thông báo:</strong>
        <p class="mt-2 text-sm text-green-700"><?php echo $successMsg; ?></p>
    </div>
<?php endif; ?>
